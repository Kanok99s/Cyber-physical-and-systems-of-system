...
FROM registry.git.chalmers.se/courses/dit638/students/2023-group-09/ubuntu:22.04 as builder
...
FROM registry.git.chalmers.se/courses/dit638/students/2023-group-09/ubuntu:22.04
LABEL maintainer="Christian Berger <christian.berger@gu.se>"
